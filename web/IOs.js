...
/*	list +="<td align=\"middle\">\n";		
	...
	{		
		...
		list +="<select class=\"INTEXT\" onchange=\"IOs["+i+"].Type=parseInt(this.value);ModParm('IOs.TimeOut');\" ";
		//if((IOs[i].Type&2)==0)
		...
		list +="</td>\n";		
		/*list +="<td align=\"middle\">\n";		
		list +="<select class=\"INTEXT\" onchange=\"IOs["+i+"].Flank=parseInt(this.value);ModParm('IOs.TimeOut');\" disabled=\"disabled\">\n";
		list +=GenOptions(OptInputFlk,IOs[i].Flank);
		list +="</select>\n";
		list +="</td>\n";// */
		list +="<td align=\"middle\">\n";		
		list +="<select class=\"INTEXT\" onchange=\"IOs["+i+"].shNivel=parseInt(this.value);ModParm('IOs.TimeOut');\" disabled=\"disabled\">\n";
		list +=GenOptions(OptInputShin,IOs[i].shNivel);
		list +="</select>\n";
		list +="</td>\n";
		list +="<td align=\"left\">\n";		
		list +="<select class=\"INTEXT\" onchange=\"IOs["+i+"].FailSts=parseInt(this.value);ModParm('IOs.TimeOut');\">\n";
		list +=GenOptions(OptInputV,IOs[i].FailSts);
		list +="</select>\n";
		list +="</td>\n";		
		list +="<td align=\"middle\">\n";		
		list +="<select class=\"INTEXT\" onchange=\"IOs["+i+"].neg=parseInt(this.value);ModParm('IOs.TimeOut');\" >\n"; //disabled=\"disabled\"
		list +=GenOptions(OptInputV,IOs[i].neg);
		list +="</select>\n";
		list +="</td>\n";
		list +="<td align=\"middle\">\n";		
		list +="<select class=\"INTEXT\" onchange=\"IOs["+i+"].TimeOut=parseInt(this.value);ModParm('IOs.TimeOut');\">\n";
